...
Thank you for considering Obvious as a potential workplace -- [we're](https://obvious.in/team/) stoked! Hiring procedures make everyone anxious and nervous -- including us -- and we want to make your experience as smooth as possible. 
...
* We expect you to use git, [commit code as you go along](engineering/release-engineering/git-commit-messages.md), and build the app iteratively -- just as you would during a normal workday. 

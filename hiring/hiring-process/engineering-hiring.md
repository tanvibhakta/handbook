...
* We expect you to use git, [commit code as you go along](../../engineering-playbook/refactoring/release-engineering/git-commit-messages.md), and build the app iteratively -- just as you would during a normal workday. 
